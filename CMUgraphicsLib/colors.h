...
const color WHITE = color("WHITE", 255, 255, 255);
const color BLACK = color("BLACK", 0, 0, 0);
...
const color BLUE = color("BLUE", 0, 0, 255);
...
const color GREEN = color("GREEN", 0, 255, 0);
...
const color YELLOW = color("YELLOW", 255, 255, 0);
...
const color ORANGERED = color("ORANGERED", 255, 69, 0);
const color RED = color("RED", 255, 0, 0);
...
const color MAGENTA = color("MAGENTA", 255, 0, 255);
